...
public class CommentActivity extends AppCompatActivity {
    ...
    private void sendComment(final String eventId) {
        ...
        mDatabaseReference.child("comments").child(key).setValue(comment,
    ...
    private void getData(final String eventId, final CommentAdapter commentAdapter) {
        mDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mDatabaseReference.getRef().child("events").child("eventId").child("commentNumber")
                        .setValue(comments.size());
